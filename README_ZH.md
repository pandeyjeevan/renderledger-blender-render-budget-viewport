...
- **渲染采样日志** (Render sample journal) — 规划模块，尚未实现。
- **场景资源工作表** (Scene resource worksheet) — 规划模块，尚未实现。
- **设备比较笔记** (Device comparison notes) — 规划模块，尚未实现。
...
- [blender](https://www.blender.org/) — 参考了官方项目资料；这并不等于市场份额数据。 (2026-09-16T14:21:04.0602728Z)
